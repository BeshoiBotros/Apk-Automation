...
class AppManagement(models.Model):
    ...
    first_screen_screenshot_path = models.ImageField(upload_to='apk/images/first_screen_screenshot_path/', null=True, blank=True)
    second_screen_screenshot_path = models.ImageField(upload_to='apk/images/second_screen_screenshot_path', null=True, blank=True)
